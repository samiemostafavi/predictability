...
comp_plot_conditionals(ax,fig,mylim,[0,35]); %35 for 0.8, 120 for 0.5

% export_fig geogeo1_validation1.eps -m10
% export_fig geogeo1_validation1.png -m10
% savefig( fig , 'geogeo1_validation1.fig' )
...
calc_and_plot_exact(1, c_mu, util, K, Llims, Lres, zlims, "#545454", "-", "s", 1, 3);
hold on;
calc_and_plot_approx(1, c_mu, util, K, Llims, Lres, zlims, "#174aa8", "--", "s", 1, 3);
hold on;

calc_and_plot_exact(4, c_mu, util, K, Llims, Lres, zlims, "#545454", "-", "*", 1, 3);
hold on;
calc_and_plot_approx(4, c_mu, util, K, Llims, Lres, zlims, "#174aa8", "--", "*", 1, 3);
hold on;

calc_and_plot_exact(8, c_mu, util, K, Llims, Lres, zlims, "#545454", "-", "^", 1, 3);
hold on;
calc_and_plot_approx(8, c_mu, util, K, Llims, Lres, zlims, "#174aa8", "--", "^", 1, 3);
hold on;

calc_and_plot_exact(12, c_mu, util, K, Llims, Lres, zlims, "#545454", "-", "o", 1, 3);
hold on;
calc_and_plot_approx(12, c_mu, util, K, Llims, Lres, zlims, "#174aa8", "--", "o", 1, 3);
hold on;
...
% export_fig geogeo1_evaluation1.eps -m10
% export_fig geogeo1_evaluation1.png -m10
% savefig( fig , 'geogeo1_evaluation1.fig' )
